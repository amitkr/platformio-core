...
* Renamed ``envs_dir`` option to (`build_dir <http://docs.platformio.org/page/projectconf/section_platformio.html#include-dir>`__).
  Default value is now set to "build" instead of old ".pioenvs".
